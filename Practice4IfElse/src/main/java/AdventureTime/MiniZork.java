...
public class MiniZork {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("You are standing in an open field "
        ...
        if (action.equals("open the mailbox")) {
            ...
            if (action.equals("look inside")) {
                ...
                System.out.println("It's really very dark. So ... "
                        + "so very dark.");
                System.out.print("Run away or keep looking? ");
                action = userInput.nextLine();

                if (action.equals("keep looking")) {
                    System.out.println("Turns out, hanging out around dark "
                            + "places isn't a good idea.");
                    System.out.println("You've been eaten by a grue.");
                } else if (action.equals("run away")) {
                    System.out.println("You run away screaming across the"
                            + " fields - looking very foolish.");
