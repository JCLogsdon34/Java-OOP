...
import com.sg.practice3.*;
import java.util.Scanner;
/**
 *
 * @author apprentice
 */
public class QuesForTheUserInput {
    public static void main(String[] args){
        ...
        System.out.println("when you didn't even know if the swallow was"
        + "African or European?");
        
        System.out.println("Maybe skip anwsering things about birds and instead"
        + " "  + "go" + " " + yourQuest);
    }
}
